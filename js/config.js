...
const MK_CONFIG = {
  ...
  pages: {
      ...
      conditions: [
        {
          title: '지원 교과 영역',
          type: 'tags+text',
          tags: ['국어','수학','영어','사회','과학','자율활동','동아리','진로','행특'],
    ...
    'rm-b': {
      ...
      conditions: [
        { title: '지원 범위', type: 'tags+text', tags: ['국어','수학','영어','사회','과학'], text: '교과 세특 전 영역. 주요교과 영역별 최대 2건 제공.' },
  ...
  /* ============================================================
   * 4. 연간관리형 전체 안내 노티스
   *    overviewNotice  : 하위 호환용 (구버전 데이터 마이그레이션 시 사용)
   *    overviewNotices : 배열 방식 — 메인화면에서 추가/편집/삭제
   * ============================================================ */

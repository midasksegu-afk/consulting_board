      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            '계약시점부터 필요한 개인정보 수집 및 이용에 동의가 된 것으로 판단하며, 제3자에게 정보 제공하지 않습니다. 해당 정보는 가입 철회시 또는 고등학교 졸업 시점까지 보유 및 이용하며 입시관련 성적 및 자료, 합격대학 통계를 위한 정보 활용 동의도 포함됩니다. (수집범위 : 성적표, 연락처 및 기타 신상정보)',
            '관리 종료 이후 컨설팅 제공실적(추천 주제, 기재 정리 파일, 활동 포트폴리오 등 학생부 전략 제반 정보)은 마이더스K교육컨설팅의 자산으로 귀속 처리됩니다.',
          ],
        },
        {
          title: '❒ 가입해지 시 환불규정',
          ...
          note: '프로그램 해지 시 위의 기간별 환불규정이 적용되며, 더불어 아래 항목별 차감금액에 따라 제공받은 컨설팅 항목 누적금액이 가입기간에 따른 환불금액보다 많을 경우에는 최종 환불 금액이 더 적거나 없을 수 있습니다. 또한 제공받은 컨설팅 내역이 없더라도 가입 기간이 종료된 후에는 환불이 불가합니다. 보고서 미접수로 인해 세특 기재를 못 받은 경우에도 가입 기간이 경과하면 관리는 자동 종료되며 환불이나 다른 컨설팅으로 변경이 불가합니다. 상호 인지하에 해지 의사를 명확히 밝힌 일자가 \'해지확정일자\'이며, 환급금은 가입시작일로부터 해지확정일자 기준으로 정산됩니다.',
        },
        {
...
<table class="sg-table">
  ...
  <tbody>
    ...
    <tr><td>3</td><td>A.세특전략 — 학생부 분석 및 심화 확장 주제 추천</td><td>회당 300,000</td></tr>

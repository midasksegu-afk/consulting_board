    ...
    terms: {
      ...
      sections: [
        ...
        },
        {
          ...
          type:  'list',
          items: [
            '학생부 전략 컨설팅은 학기 및 학년 단위 관리 서비스로 결제와 동시에 효력이 발생하며, 1년 단위 계약이 아니라 약관에 명시한 기한을 따릅니다.',
            '계약시점부터 필요한 개인정보 수집 및 이용에 동의가 된 것으로 판단하며, 제3자에게 정보 제공하지 않습니다. (수집범위 : 연락처 및 기타 신상정보)',
          ],
        },
        {
          title: '❒ 가입해지 시 환불규정',
          ...
          note: '프로그램 해지 시 위의 기간별 환불규정이 적용되며, 더불어 아래 항목별 차감금액에 따라 제공받은 컨설팅 항목 누적금액이 가입기간에 따른 환불금액보다 많을 경우에는 최종 환불 금액이 더 적거나 없을 수 있습니다. 또한 제공받은 컨설팅 내역이 없더라도 가입 기간이 종료된 후에는 환불이 불가합니다. 예를 들어, 보고서 미접수로 인해 세특 기재를 못 받은 경우에 가입 기간이 경과하면 관리는 자동 종료되며 환불이나 다른 컨설팅으로 변경이 불가합니다. 상호 인지하에 해지 의사를 명확히 밝힌 일자가 \'해지확정일자\'이며, 환급금은 가입시작일로부터 해지확정일자 기준으로 정산됩니다.',
        },
        {
...
<table class="sg-table">
  ...
  <tbody>
    <tr class="sg-group-row"><td colspan="3">학년전략 로드맵</td></tr>
    <tr><td>1</td><td>A.세특전략 — 세특 강화 솔루션 (1과목 이상 기재 요약 및 기재 제출 지원 진행 시)<br><span style="font-size:11px;color:#666;">단, 자퇴 및 휴학, 해외 유학과 같이 불가피하다고 판단 될 경우에 한해 진행 건당 10만원 차감 후 환불 가능</span></td><td>학기당 1,300,000</td></tr>
    <tr><td>2</td><td>A.세특전략 — N차 심화 탐구 연결 주제 기획 (세특구원자 보고서 설계도 별도 과금)</td><td>건당 100,000</td></tr>
    <tr><td>3</td><td>A.세특전략 — 학생부 전략 및 심화 확장 주제 추천</td><td>회당 300,000</td></tr>
    <tr><td>4</td><td>B.수행전략 (1건 이상 수행에 관한 컨설팅 지원 시)</td><td>학기당 1,300,000</td></tr>
    <tr><td>5</td><td>C.주제추천 — 방향성 코칭 (회원 유지시 무료이나 가입 철회시 컨설팅 업무 발생을 기준으로 과금)</td><td>회당 100,000</td></tr>
    <tr><td>6</td><td>D.대면컨설팅 — RPM 컨설팅 (활동 코칭 및 활동 방향 설계)</td><td>회당 100,000</td></tr>
    <tr><td>7</td><td>D.대면컨설팅 — 성적분석 초기 SYSTEM 세팅 / 성적 입력시</td><td>100,000 / 300,000</td></tr>
    <tr><td>8</td><td>D.대면컨설팅 — 맞춤 진로 진학 상담 및 질의응답 진행시</td><td>회당 100,000</td></tr>
    <tr><td>9</td><td>E.기본전략 — 학종특강 (수업 미진행시 부과하지 않음)</td><td>회당 200,000</td></tr>
    <tr><td>10</td><td>E.기본전략 — 행정관리 (상담 스케줄, 컨설팅 밴드 운영관리)</td><td>월별 100,000</td></tr>
    <tr class="sg-group-row"><td colspan="3">대입전략 컨설팅</td></tr>
    <tr><td>11</td><td>수시 원서전략 컨설팅 (수시 예비 상담 이후 환불 불가)</td><td>회당 400,000</td></tr>
    <tr><td>12</td><td>정시 원서전략 컨설팅 (환불 규정에 의거 처리)</td><td>회당 350,000</td></tr>
    <tr><td>13</td><td>가채점 컨설팅 (상담 이후 환불 불가)</td><td>회당 100,000</td></tr>
    <tr><td>14</td><td>면접 컨설팅 (대면 미진행 시 20만원 차감)</td><td>350,000 / 400,000</td></tr>
  </tbody>
</table>`,
        },
      ],
    ...
    policy: {
      ...
      title:       '컨설팅 운영 방침 동의서',
      signerLabel: '가입자',
      intro: '마이더스K교육컨설팅은 대구광역시 교육청 컨설팅부문 정식인가(제5513호) 학원(업체)으로 \'학교생활기록 상업적 이용 제한 관련 법령 및 교육부 시행지침\'을 준수하고 이를 고지합니다.',
      sections: [
        {
        ...
        {
          title: '❐ 학생부 전략 컨설팅 운영 방식 안내 (세부규정)',
          type:  'sub-title',
        },
        {
          title: '01. 공통',
          ...
          items: [
            ...
            '마이더스K는 학생의 생기부 경쟁력 구축에 역량을 집중하기 위해 컨설팅 프로그램을 \'세특전략\', \'수행전략\', \'주제추천\', \'대면전략\', \'기본전략\'로 구분하여 운영합니다. 이에 각 프로그램은 가입 약관에 명시된 컨설팅 항목, 프로그램 구성, 제공 횟수 기준 등에 따라 관리가 진행됩니다.',
            ...
            '수시 학생부종합전형에서 탐구 주제 자체를 평가하는 경우는 없습니다. 결국 학생답게 진행한 진정성 있는 탐구 활동이 가장 높은 평가 점수를 받게 됩니다. 마이더스K의 모든 컨설팅 프로그램은 학생의 탐구 과정과 학습 성장을 촉진하는 방향으로 설계되었으며, 학생이 주도적으로 탐구를 이어갈 수 있도록 필요한 과정 안에서 책임 있게 지원합니다. 다만 컨설팅의 성격상 탐구 과정과 횟수 전반에 대해 무한 책임을 보장하는 형태는 아님을 먼저 밝혀 드립니다.',
          ],
        },
        {
          title: '02. A. 세특 전략',
          type:  'numbered',
          items: [
            '학생이 실제로 수행한 기록물에 대해서만 기재 요약본을 제공합니다. 증빙 기록물이 없거나 단순 신문 스크랩, 책자 사진만 제출한 경우에는 컨설팅이 제한될 수 있습니다.',
            ...
            '학생부 활동 기록을 위한 자기평가서 제공 이후의 수정 요청은 컨설턴트가 중요한 수정 사항이나 누락 사항이 있다고 판단한 경우, 또는 학생이 구체적인 수정 요청 사항을 직접 전달한 경우에 한해 가능합니다. 다만 수정 요청 내용이 학생부종합전형의 서류 평가 방향이나 기재 적합성에 부합하지 않는다고 컨설턴트가 판단하는 경우, 해당 수정은 제한될 수 있습니다.',
            '심화 확장 스토리 구축 과정에서 이전 활동과 연결되는 주제는 세특구원자 플랫폼을 통해 관리 밴드에 링크 또는 댓글 방식으로 제공하는 것을 원칙으로 합니다. 모든 활동에 대해 심화 확장 주제가 추천되는 것은 아니며, 활동의 연계 가능성, 세특 경쟁력, 기재 적합성 등을 종합적으로 판단하여 선별적으로 제공합니다.',
            '교과별 기재 요약본의 경우, 학생부 경쟁력과 활동 적합성을 기준으로 우선순위가 높은 2~3개의 우수 활동을 선별하여 제공합니다.',
          ],
        },
        {
          title: '03. B. 수행 전략',
          type:  'numbered',
          items: [
            '수행전략 프로그램은 수행평가 준비 과정에서 발생하는 불필요한 시간 소모를 줄이고 정리할 수 있도록 돕는 것을 목표로 합니다. 다만 어려운 수학 문제의 풀이 과정, 자신의 롤 모델 조사처럼 개인적 감상이나 경험이 중심이 되는 활동, 학교 행사 참여 보고서처럼 학생 본인만이 확인하고 작성할 수 있는 내용은 학생의 고유한 경험과 사고가 반영되어야 하는 영역으로 활동 지원이 제한될 수 있습니다.',
            '수행전략 결과물은 수행평가의 공정성을 침해하지 않는 범위에서 탐구 방향, 보고서 흐름, 핵심 기준 정리, 발표 구성 등의 형태로 제공되며, 완성본 대행 또는 제출용 문안 작성은 제공하지 않습니다. 요청 시 학생은 과목명, 제출 형식, 제출 기한, 학교 안내문 등 최소한에 필요한 기본 자료를 함께 제공해야 하며, 자료가 불충분한 경우 지원이 제한될 수 있습니다.',
            '옵션 A(방향성 코칭)는 학생이 수행평가를 준비할 때 탐구 주제 선정, 자료 활용, 보고서 전개 방식 등 기본 방향을 잡을 수 있도록 코칭하는 방식입니다. 옵션 B(세특구원자 활용)는 학생이 수행평가 보고서를 실제로 작성할 수 있도록 탐구 주제, 논문 및 도서 등 검증된 자료, 과정, 결과 및 고찰 패키지로 구성된 보고서 설계도 및 초안을 제시하는 방식입니다. 수행평가의 조건과 학생의 준비 상황에 따라 옵션 A와 옵션 B를 융합하여 제공할 수 있습니다.',
            '수행전략에서 제공되는 자료와 코칭 내용은 학생의 수행평가 준비를 돕기 위한 참고 자료이며, 학교 제출물의 최종 작성 및 제출 책임은 학생에게 있습니다. 학생은 제공된 방향과 자료를 바탕으로 자신의 이해와 표현에 맞게 보고서를 재구성해야 합니다.',
            '수행평가의 평가 결과, 점수, 교사 피드백, 생기부 반영 여부 등은 학교의 평가 기준과 교사의 판단에 따라 달라질 수 있으므로, 수행전략 프로그램이 특정 결과를 보장하지는 않습니다. 따라서 학생은 자신의 수업 맥락, 수행 조건, 교사의 안내 기준에 맞게 제공된 내용을 수정하고 더 발전시켜 활용하는 것을 권장드립니다.',
          ],
        },
        {
          title: '04. C. 주제 추천',
          type:  'numbered',
          items: [
            '모든 수행평가 활동에서 주제를 추천받는 방식은 학생의 탐구 주도성을 저해하고, 학생다운 활동의 자연스러운 형성을 방해할 수 있습니다. 이에 마이더스K는 일괄 과금 방식이 아니라 학생의 상황과 필요에 따라 탐구 주제 추천 프로그램을 선택적으로 운영합니다. 특히 세특구원자를 통해 학생이 24시간 스스로 탐구 주제를 탐색하고 선정할 수 있도록 지원합니다.',
            '교과 세특은 무분별하게 진로와 연결하기보다 교과목 개념의 심화 확장 주제로 삼는 것이 평가에서 더 유리합니다. 예를 들어 수학 문제집을 풀 때 어렵거나 흥미로웠던 지점을 의문점이나 호기심 포인트로 삼고, 이를 확인하는 수행 주제로 발전시키면 학업 성취와 수행평가 결과를 함께 높이는 데 도움이 될 수 있습니다.',
            '컨설팅 지원 업무시간 이후 긴급한 주제 선정이 필요한 경우, 우선 관리 밴드 내 \'나만의 심화 확장\' 게시판을 확인해 주시기 바랍니다. 해당 게시판에서 적절한 주제를 찾기 어려운 경우에는 세특구원자에서 교과 및 진로 키워드를 검색하여 주제를 탐색할 수 있습니다. 이후 선정한 주제를 RPM시간이나 관리 밴드에 공유해 주시면, 필요에 따라 해당 주제와 이전 활동을 연결한 심화 확장 방향을 안내해 드립니다.',
            '수행 조건이 충분히 제시되지 않은 요청이나, 개인적 판단 또는 선호에 따라 동일 활동에 대해 반복적으로 이루어지는 주제 변경 요청은 지원이 제한될 수 있습니다.',
            '실험 여건이나 학교 기자재 확인이 어려운 실험 활동은 주제 추천이 제한될 수 있습니다. 실험 활동에서는 실험의 난이도 자체보다 학생이 어떤 호기심에서 출발했는지, 과정에서 어떤 의문을 발견해 심화 확장했는지가 더 중요합니다. 따라서 단순한 실험이라도 학생의 문제의식과 설계 과정, 2차 탐구로 이어지는 방향으로 코칭을 진행합니다.',
          ],
        },
      ],
      finalNotes: [
        ...
        <div class="sg-form-grid">
          ...
          <div class="sg-form-row">
            ...
            <div style="display:flex;gap:6px;align-items:center;">
              ...
              <input class="sg-input sg-input-auto" id="f-product" value="학생부 전략 컨설팅" readonly style="flex:1;">
            </div>
          </div>
          <div class="sg-form-row">
  ...
  function _collectFormData() {
    ...
    if (_currentTab === 'terms') {
      ...
      const product = grade ? `${grade} 학생부 전략 컨설팅` : '학생부 전략 컨설팅';
      return {
        name:    get('f-name'),
        school:  get('f-school'),
        product,
  ...
  function printBoth() {
    ...
    const termsForm = {
      ...
      product: gradeVal ? `${gradeVal} 학생부 전략 컨설팅` : '학생부 전략 컨설팅',
    ...
    const infoTableHtml = data.docType === 'terms' ? `
      <div class="sg-info-card">
        <table class="sg-info-table">
          ...
          <tr>
            <th>상품명</th>
            <td colspan="3">${form.product || '학생부 전략 컨설팅'}</td>
          </tr>
          <tr>
            <th>가입기간</th>
            <td colspan="3">
...
<div class="sg-pr-page">
  ...
  <div class="sg-pr-footer">
    <div>
      <div class="sg-pr-footer-brand">티처스 컨설턴트의 학생부 전략 컨설팅</div>
  ...
  function _buildConsultingTable(gradeNum, selectedPages, isSemesterDc) {
    ...
    const roadmapPages = [
      { id: 'rm-a', label: 'A. 세특 전략',
        programs: [
          ...
          { title: '2. 심화 확장 스토리 구축',
            desc: '❶ N차 심화 탐구 연결 (기재전략 시 선별)<br>❷ 이전 활동을 심화 확장하는 수행 및 창체 활동 주제 + 보고서 설계도 제공<br>❸ 학생부 분석 및 심화 확장 주제 추천',
            freq: '상시제공 (학생부 분석 연1회)' },
        ],
      },
      { id: 'rm-b', label: 'B. 수행 전략',
        programs: [
          { title: '1. 수행 조건 분석',
      ...
      { id: 'rm-c', label: 'C. 주제 추천',
        programs: [
          { title: '1. 탐구 주제 + 보고서 설계도 제공',
            desc: '❶ 탐구 동기, 과정, 도서·논문 등 참고자료, 결과 및 고찰점 ALL 포함 패키지<br>❷ 건당 5,500~7,500원 / 월구독 95,000원 (로드맵 컨설팅 회원 대상: 매달 30% 할인 쿠폰코드 제공)',
            freq: '상시제공' },
          { title: '2. 방향성 코칭',
            desc: '❶ 학생이 주도적으로 결정한 활동에 한해 관련 자료 및 방향성 코칭 무료 지원<br>❷ 수행 공지를 밴드에 올리면 자동 지원',
            freq: '무료' },
          { title: '3. 세특구원자 플랫폼 활용',
            desc: '❶ 24시간 키워드 검색으로, 필요한 시간대에 즉시 탐구 주제 직접 선정 가능<br>❷ 주요대·메디컬 합격자 주제 업그레이드 제공<br>❸ 로드맵 컨설팅 회원 구독 할인 적용<br>생성형 AI + 세특구원자 같이 활용시 실존 논문 도서 기반 탐구 보고서 작성시간이 5~10분으로 단축됩니다.',
            freq: '상시제공' },
        ],
      },
      // D. 대면관리 — 모든 학년 공통 (필수)
      { id: 'rm-d', label: 'D. 대면전략 (필수)',
        programs: [
          { title: '1. RPM 컨설팅 (Roadmap·Planning·Mentoring)',
            desc: '❶ 교과 & 창체 세특 코칭 + 활동 방향 설계<br>❷ 동아리·진로 등 창체 주제 선정이 막힐 경우 구체적 실행 방안 제시<br>❸ 단, 수행전략 ONLY 회원 창체(자율, 동아리, 진로) 활동에 대한 주제 추천은 세특구원자 6개월~1년 기간 구독자에 한해 지원. (단, 1건 이상 주제 추천 후 가입철회 시 세특구원자 구독료 환불 불가)',
            freq: '연 관리' },
          { title: '2. 성적 누적 분석',
    ...
    // 학년전략 로드맵
    rows += `<tr class="sg-group-row"><td colspan="4">학년전략 로드맵</td></tr>`;
  ...
  function _extractTermsText(data) {
      ...
      if (sec.type === 'consulting-items') {
        const roadmapPages = [
          ...
          { label: 'C. 주제 추천', programs: [
            { title: '1. 탐구 주제 + 보고서 설계도 제공', desc: '탐구 동기, 과정, 도서·논문 등 참고자료, 결과 및 고찰점 ALL 포함 패키지. 건당 5,500원에서 7,500원, 월구독 95,000원, 로드맵 컨설팅 회원 대상 매달 30% 할인 쿠폰코드 제공' },
            { title: '2. 방향성 코칭', desc: '학생이 주도적으로 결정한 활동에 한해 관련 자료 및 방향성 코칭 무료 지원. 수행 공지를 밴드에 올리면 자동 지원' },
            { title: '3. 세특구원자 플랫폼 활용', desc: '24시간 키워드 검색으로 필요한 시간대에 즉시 탐구 주제 직접 선정 가능. 주요대·메디컬 합격자 주제 업그레이드 제공. 로드맵 컨설팅 회원 구독 할인 적용. 생성형 AI와 세특구원자 같이 활용시 실존 논문 도서 기반 탐구 보고서 작성시간이 5분에서 10분으로 단축됩니다.' },
          ]},
          { label: 'D. 대면전략 (필수)', programs: [
    ...
    if (Array.isArray(data.finalNotes)) {
      data.finalNotes.forEach(n => {
        const tmp = document.createElement('div');
        tmp.innerHTML = n;
  ...
  function openTtsModal() {
      ...
      <div style="
        ...
        <div style="
          ...
          <button id="mk-tts-stop" style="
            ...
            color:#2A3340;font-size:14px;font-weight:600;font-family:inherit;">
    ...
    function stopAll() { synth.cancel(); setPlayUI(false); }

    function closeModal() { stopAll(); overlay.remove(); }
    ...
    document.getElementById('mk-tts-play').addEventListener('click', () => {
      ...
      else { setPlayUI(true); speakLine(currentLine); }
    });

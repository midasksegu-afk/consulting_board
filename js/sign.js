    ...
    policy: {
      ...
      sections: [
        ...
        },
        {
          ...
          type:  'numbered',
          items: [
            '수행전략 프로그램은 수행평가 준비 과정에서 발생하는 불필요한 시간 소모를 줄이고 정리할 수 있도록 돕는 것을 목표로 합니다. 다만 어려운 수학 문제의 풀이 과정, 자신의 롤 모델 조사처럼 개인적 감상이나 경험이 중심이 되는 활동, 학교 행사 참여 보고서처럼 학생 본인만이 확인하고 작성할 수 있는 내용은 활동 지원이 제한될 수 있습니다.',
            '수행전략 결과물은 수행평가의 공정성을 침해하지 않는 범위에서 탐구 방향, 보고서 흐름, 핵심 기준 정리, 발표 구성 등의 형태로 제공되며, 완성본 대행 또는 제출용 문안 작성은 제공하지 않습니다.',
            ...
            '수행전략에서 제공되는 자료와 코칭 내용은 학생의 수행평가 준비를 돕기 위한 참고 자료이며, 학교 제출물의 최종 작성 및 제출 책임은 학생에게 있습니다.',
            '수행평가의 평가 결과, 점수, 교사 피드백, 생기부 반영 여부 등은 학교의 평가 기준과 교사의 판단에 따라 달라질 수 있으므로, 수행전략 프로그램이 특정 결과를 보장하지는 않습니다.',
          ],
        },
        {
          title: '04. C. 주제 추천',

...
<table class="sg-table">
  ...
  <tbody>
    ...
    <tr><td>1</td><td>A.세특관리 — 세특 강화 솔루션 (1과목 이상 기재 요약 및 기재 제출 지원 진행 시)<br><span style="font-size:11px;color:#666;">단, 자퇴 및 휴학, 해외 유학과 같이 불가피하다고 판단 될 경우에 한해 진행 건당 10만원 차감 후 환불 가능</span></td><td>학기당 1,300,000</td></tr>
      ...
      { id: 'rm-d', label: 'D. 대면관리 (필수)',
        programs: [
          { title: '1. RPM 컨설팅 (Roadmap·Planning·Mentoring)',
            desc: '❶ 교과 & 창체 세특 코칭 + 활동 방향 설계<br>❷ 동아리·진로 등 창체 주제 선정이 막힐 경우 구체적 실행 방안 제시<br>❸ 단, 수행관리 ONLY 회원 창체(자율, 동아리, 진로) 활동에 대한 주제 추천은 세특구원자 6개월~1년 기간 구독자에 한해 지원. (단, 1건 이상 주제 추천 후 가입철회 시 세특구원자 구독료 환불 불가)',
            freq: '연 관리' },
          { title: '2. 성적 누적 분석',

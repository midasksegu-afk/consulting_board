      ...
      sections: [
        {
          ...
          type:  'numbered',
          items: [
            '보고서를 통한 활동 기재본 정리가 원칙이나, 학생이 직접 작성한 자기평가서 첨삭은 아래 \'첨삭기준\'에 의거하여 진행합니다. \'첨삭기준\' — 학생으로부터 작성된 원본 내용 중 학문적 오류는 책임지지 않으며, 그 내용이 부적절하다고 판단될 때 첨삭을 지원하지 않을 수 있습니다.',
        ...
        },
        {
          ...
          type:  'numbered',
          items: [
            '기재 전략 컨설팅 프로그램은 별도 내방 없는 온라인 관리 컨설팅입니다. 또한 가입 시기 상관없이 학년 및 학기 단위 관리이며, 결제와 동시에 효력이 발생합니다. (단. 반드시 지정된 밴드 게시글로 업로드된 자료만 지원합니다, 즉 카톡, 전화, 메일, 문자, 밴드 채팅 등 요청 건 지원 불가)',
            '계약시점부터 개인정보 수집 및 이용에 동의가 된 것으로 판단하며, 제3자에게 정보 제공하지 않습니다. (수집범위 : 연락처 및 기타 신상정보)',
      ...
      sections: [
        {
          ...
          items: [
            ...
            '옵션 A(방향성 코칭)는 학생이 수행평가를 준비하는 과정에서 탐구 주제 선정, 자료 활용, 보고서 전개 방식 등 기본 방향을 설정할 수 있도록 보고서 틀과 관련 코멘트를 제공하는 방식입니다. 옵션 B(세특구원자 활용)는 탐구 주제, 논문 및 도서 등 검증된 자료, 과정, 결과 및 고찰 패키지로 구성된 마이더스K 탐구주제 플랫폼 \'세특구원자\'의 보고서 설계도와 관련 코멘트를 제공하는 방식입니다.',
            '단. \'옵션B\'의 세특구원자 보고서 설계도는 별도 과금 됩니다. (건당 5,500~7,500원) ❈ 수행 전략 회원은 요청 시 마이더스K교육컨설팅의 공식 탐구 주제 플랫폼인 \'세특구원자\'의 기간 구독 6개월, 1년 또는 월 구독 할인(40~50%)혜택을 제공받을 수 있습니다.',
        ...
        },
        {
          ...
          type:  'numbered',
          items: [
            '수행 전략 컨설팅 프로그램은 별도 내방 없는 온라인 관리 컨설팅입니다. 또한 가입 시기 상관없이 학년 및 학기 단위 관리이며, 결제와 동시에 효력이 발생합니다. (단. 반드시 지정된 밴드 게시글로 업로드된 자료만 지원합니다, 즉 카톡, 전화, 메일, 문자, 밴드 채팅 등 요청 건 지원 불가)',
            '계약시점부터 개인정보 수집 및 이용에 동의가 된 것으로 판단하며, 제3자에게 정보 제공하지 않습니다. 동의 철회시 또는 고교 졸업시점까지 보유 및 이용하며, 합격대학 통계를 위한 정보 활용 동의도 포함됩니다. 단, 고3의 경우 합격 대학 및 학과 정보 활용 동의도 포함됩니다. (수집범위 : 성적표, 연락처 및 기타 신상정보)',
        ...
        },
        {
          ...
          type:  'numbered',
          items: [
            '영업 기밀 누출에 관한 보호 차원에서 1개 이상 수행 전략 지원 후 해당 학기의 컨설팅 금액은 환불 불가합니다. 단, 1년 가입 시 학기가 시작하기 전의 경우에는 해당 학기의 컨설팅 금액이 환불 가능합니다. (자퇴, 유학, 건강 문제와 같이 불가피한 상황이라고 판단 될 경우 기재 건당 10만원 차감 후 환불)',
            '수행 전략 컨설팅을 받지 않은 경우에도 가입기간 경과 이후에는 환불이나 다른 컨설팅으로 변경 불가합니다.',
            '환급금은 가입 해지 의사를 명확히 표시한 해지확정일자를 기준으로 정산됩니다.',
          ],
        },
        {
        ...
        },
        {
          ...
          type:  'numbered',
          items: [
            '본 컨설팅은 학교 수행 탐구 활동 전반에 대한 결과를 보장하거나 무한한 책임을 부담하는 서비스가 아니며, 학생의 탐구 방향 설정과 학습 성장을 지원하는 것을 목적으로 합니다. 또한 수행 이후 자기평가서 작성, 활동 내용 정리, 세특 반영 전략 수립 등 세특 기재 전략에 해당하는 과정은 별도의 \'기재 전략 프로그램\'을 통해 진행됨을 미리 알려 드립니다.',
            '수행전략 결과물은 수행평가의 공정성을 침해하지 않는 범위에서 탐구 방향, 보고서 흐름, 발표 구성 등의 틀(초안) 형태로 제공되며, 완성본 대행 또는 제출용 문안 작성은 제공하지 않습니다. 요청 시 학생은 과목명, 제출 형식, 제출 기한, 학교 안내문 등 최소한에 필요한 기본 자료를 함께 제공해야 하며, 자료가 불충분한 경우 지원이 제한될 수 있습니다.',
    ...
    gyogwa: {
      ...
      sections: [
        ...
        },
        {
          ...
          type:  'numbered',
          items: [
            '교과 + 정시 전략 컨설팅은 1년 단위 관리 프로그램이며, 결제와 동시에 효력이 발생합니다.',
            '계약시점부터 필요한 개인정보 수집 및 이용에 동의가 된 것으로 판단하며, 제3자에게 정보 제공하지 않습니다. 동의 철회시 또는 고등학교 졸업시점까지 보유 및 이용하며 입시관련 성적 및 합격대학 통계를 위해 합격자 정보 활용 동의도 포함됩니다. (수집범위 : 성적표, 연락처 및 신상정보)',
        ...
        <div class="sg-form-grid">
          ...
          <div class="sg-form-row">
            ...
            <input class="sg-input sg-input-auto" id="f-product"
              value="교과 + 정시 전략 컨설팅 : 교과, 모의 성적누적 및 학습전략 컨설팅" readonly>
          </div>
          <div class="sg-form-row">
  ...
  function _collectFormData() {
    ...
    if (_currentTab === 'gyogwa') {
      return {
        name:    get('f-name'),
        school:  get('f-school'),
        product: '교과 + 정시 전략 컨설팅 : 교과, 모의 성적누적 및 학습전략 컨설팅',
        period,
        amount:  get('f-amount'),
      ...
      const product = get('f-product') || (get('f-grade')
        ? get('f-grade') + ' ' + (_currentTab === 'jaeji' ? '학생부 기재 전략 컨설팅' : '수행 전략 컨설팅')
        : (_currentTab === 'jaeji' ? '학생부 기재 전략 컨설팅' : '수행 전략 컨설팅'));
      return {
        name:    get('f-name'),
        school:  get('f-school'),
        product,
...
<div class="sg-pr-page">
  ...
  function _refillAmount() {
    ...
    if (prodEl && _currentTab !== 'gyogwa') {
      ...
      const baseName = isJaeji ? '학생부 기재 전략 컨설팅' : '수행 전략 컨설팅';
    ...
    overlay.innerHTML = `
      <div style="
        ...
        <div style="background:#2A3340;padding:16px 20px;display:flex;align-items:center;gap:12px;flex-shrink:0;">
          ...
          <span style="color:#fff;font-size:14px;font-weight:700;flex:1;" id="mk-tts-title">${data.tabLabel} — 약관 안내</span>
        ...
        <div style="
          ...
          <div style="display:flex;align-items:center;gap:8px;margin-left:auto;">
            ...
            <input type="range" id="mk-tts-rate" min="0.7" max="1.8" step="0.1" value="1.6"
              style="width:90px;">

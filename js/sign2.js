    ...
    suhaeng: {
      ...
      sections: [
        ...
        },
        {
          ...
          type:  'numbered',
          items: [
            '본 컨설팅은 학교 수행 탐구 활동 전반에 대한 결과를 보장하거나 무한한 책임을 부담하는 서비스가 아니며, 학생의 탐구 방향 설정과 학습 성장을 지원하는 것을 목적으로 합니다. 또한 수행 이후 자기평가서 작성, 활동 내용 정리 등 기재 전략에 해당하는 과정은 별도의 \'기재 전략 프로그램\'을 통해 진행됨을 미리 알려 드립니다.',
